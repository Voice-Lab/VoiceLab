...
This uses Praat's :python:`Sound: To Pitch (ac)...`, by default. You can also use the cross-correlation algorithm: :python:`Sound: To Pitch (cc)...`. For full details on these algorithms, see the `praat manual pitch page <http://www.fon.hum.uva.nl/praat/manual/Pitch.html>`_.
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureSHRPNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureCPPNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureEnergyNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureFormantNode
   :members:
...
The algorithm is as follows:
    ...
    - Third, find the mean of the scaled formants.
        ...
        - :math:`\frac{1}{n} {\sum _{i=1}^{n}{f_i}}`

This algorithm deviates from the original in that it checks the data for a normal distribution before applying the z-score. If it is not normally distributed, it uses Scikit Learn's `Robust Scalar <https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.RobustScaler.html>`_
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureVocalTractEstimatesNode
   :members:

.. automodule:: Voicelab.toolkits.Voicelab.MeasureFormantPositionsNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureHarmonicityNode
   :members:
...
s `Configuring the intensity contour Page <https://www.fon.hum.uva.nl/praat/manual/Intro_6_2__Configuring_the_intensity_contour.html>`_.

.. automodule:: Voicelab.toolkits.Voicelab.MeasureIntensityNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureJitterNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureShimmerNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureLTASNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureMFCCNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureSpectralShapeNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureSpectralTiltNode
   :members:
...
Voice Lab used version 2 of the script, available `here <https://sites.google.com/site/speechrate/Home/praat-script-syllable-nuclei-v2>`_.
...
.. automodule:: Voicelab.toolkits.Voicelab.MeasureSpeechRateNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.ManipulatePitchLowerNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.ManipulateRaiseFormantsNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.ManipulateRaisePitchAndFormantsNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.ResampleSoundsNode
   :members:
...
This script is from Chris Darwin and reproduced here with permission: `The original script can be found here
<http://www.lifesci.sussex.ac.uk/home/Chris_Darwin/Praatscripts/Spectral%20Rotation>`_.
...
.. automodule:: Voicelab.toolkits.Voicelab.ScaleIntensityNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.ManipulateTruncateSoundsNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.VisualizeVoiceNode
   :members:
...
.. automodule:: Voicelab.toolkits.Voicelab.VisualizeSpectrumNode
   :members:
