...
class VoicelabNode:
    ...
    def pitch_floor(self, file_path):
        ...
        :rtype: float
        """
        return self._extracted_from_pitch_ceiling_10(file_path, 0)
    ...
    def pitch_ceiling(self, file_path):
        ...
        :rtype: float
        """
        return self._extracted_from_pitch_ceiling_10(file_path, 1)

    # TODO Rename this here and in `pitch_floor` and `pitch_ceiling`
    def _extracted_from_pitch_ceiling_10(self, file_path, arg1):
        signal, sampling_rate = self.args['voice']
        sound: parselmouth.Sound = parselmouth.Sound(signal, sampling_rate)
        return self.pitch_bounds(file_path)[arg1]
