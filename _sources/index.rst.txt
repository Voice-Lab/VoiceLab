...
Energy can be found `here<https://osf.io/3wr6k/files/>`_.

It wass a normal Energy calculation, but the widow size is equal to 5 pitch periods, estimated by my port of Voice
Sauce's Praat script to Python using the praat-parselmouth package.

This changed in version 2.0.0
