...
from .VoicelabGUI.InputTab import InputTab
from .VoicelabGUI.OutputTab import OutputTab
from .VoicelabGUI.SettingsTab import SettingsTab
#from Voicelab.VoicelabGUI.ExperimentalTab import ExperimentalTab
from .VoicelabGUI.VoicelabController import VoicelabController
#from Voicelab.VoicelabGUI.ManipulationWindow import ManipulationWindow
from .default_settings import available_functions, default_functions
