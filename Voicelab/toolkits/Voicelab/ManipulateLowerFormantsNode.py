...
class ManipulateLowerFormantsNode(VoicelabNode):
    ...
    def process(self) -> dict[Union[str, parselmouth.Sound]]:
        ...
        try:
            ...
            number_of_channels: int = call(sound, 'Get number of channels')
            if number_of_channels == 2:
                sound: parselmouth.Sound = call(sound, 'Convert to mono')

            manipulated_sound: parselmouth.Sound = call(sound, "Change gender", f0min, f0max, formant_shift_ratio, new_pitch_median,
