...
# todo add signal to noise ratio (SNR) node
#  set Minimum dip based on signal to noise ratio (SNR) after testing
...
class MeasureSpeechRateNode(VoicelabNode):
    def __init__(self, *args, **kwargs):
        ...
        self.args = {"silencedb": -25,  # negative integer
                     "mindip": 4,  # positive integer
    ...
    def process(self):
        ...
        try:
            ...
            return {
                "Number of Syllables": "Measurement failed.",
                "Number of Pauses": "Measurement failed.",
                "Duratrion(s)": "Measurement failed.",
                "Phonation Time(s)": "Measurement failed.",
                "speechrate(Number of Syllables / Duration)": "Measurement failed.",
                "Articulation Rate(Number of Syllables / phonationtime)": "Measurement failed.",
                "ASD(Speaking Time / Number of Syllables)": "Measurement failed.",
            }
